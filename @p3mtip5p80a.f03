!************************************************** May, 2023 ****
!*                                                               *
!*   ## Molecular Dynamics of Methane Hydrate by TIP5P Code ##   *
!*     - Microwaves heating and collapse (if_xyz1=.true.) -      * 
!*                                                               *
!*   Author/Maintainer: Motohiko Tanaka, Ph.D.                   *
!*           Innovative Energy Science, Chubu University, Japan  *
...
!*   2. param_tip5p_D80a.h : parameter file, physical constants  *
...
!*                                                               *
!*  1 >>> run's name is given by param_tip5p_D80a.h              *
!*                                                               *
...
!------------------------------------------------------------------
      use, intrinsic :: iso_c_binding 
      implicit none
      include  'param_tip5p_D80a.h'  !! <- suffix1
!
      integer(C_INT)   io_pe
      common/sub_proc/ io_pe
!
...
!************************
      use, intrinsic :: iso_c_binding 
      implicit none
      include  'param_tip5p_D80a.h'  !! <- kstart,praefixi
!
!   npq5 = nq0 +np0
!   npq0 = nq0/5 +np0
!   nq1 = nq0/5
